...
mysql_query("UPDATE leader SET $date = '$points13' WHERE Name = '$name13'");
   	...
   	$result14 = mysql_query("SELECT * FROM leader WHERE Name = '$name14' ");
mysql_query("UPDATE leader SET $date = '$points14' WHERE Name = '$name14'");

   	$result15 = mysql_query("SELECT * FROM leader WHERE Name = '$name15' ");
mysql_query("UPDATE leader SET $date = '$points15' WHERE Name = '$name15'");

   	$result16 = mysql_query("SELECT * FROM leader WHERE Name = '$name16' ");
mysql_query("UPDATE leader SET $date = '$points16' WHERE Name = '$name16'");

   	$result17 = mysql_query("SELECT * FROM leader WHERE Name = '$name17' ");
mysql_query("UPDATE leader SET $date = '$points17' WHERE Name = '$name17'");

   	$result18 = mysql_query("SELECT * FROM leader WHERE Name = '$name18' ");
mysql_query("UPDATE leader SET $date = '$points18' WHERE Name = '$name18'");

   	$result19 = mysql_query("SELECT * FROM leader WHERE Name = '$name19' ");
mysql_query("UPDATE leader SET $date = '$points19' WHERE Name = '$name19'");

   	$result20 = mysql_query("SELECT * FROM leader WHERE Name = '$name20' ");
mysql_query("UPDATE leader SET $date = '$points20' WHERE Name = '$name20'");
