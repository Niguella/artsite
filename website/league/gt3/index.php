...
$result = mysql_query("SELECT Name,Points,Race1,Race2,Race3,Race4,Race5,Race6,Race7,Race8, Race9, Race10, sum(Race1 + Race2 + Race3 + Race4 + Race5 + Race6 + Race7 + Race8 + Race9 + Race10 ) as Total FROM leader GROUP BY Name");
...
// calculate totals and update
        $result = mysql_query("SELECT team, sum(Points) as point from leader group by team ORDER BY point DESC");
        $rank = 1;
