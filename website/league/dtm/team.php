...
$result  = mysql_query("SELECT team, Race1, Race2, Race3, Race4, Race5, Race6, Race7, Race8, sum(Race1 + Race2 + Race3 + Race4 + Race5 + Race6 + Race7 + Race8) as total from leader1 group by team");
